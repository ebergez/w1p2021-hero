...
URL du site : https://emrasstory.netlify.com/

Schéma numérique: https://i.imgur.com/74NJu5F.png
...
| État | Le choix du personnage et/ou de ses caractéristiques impacte l'aventure au moins une fois. **Indiquez ici comment succintement.** un meme choix peu vous faire perdre ou gagner selon le personnage choisi.| Non, chaque personnage a la même histoire |
...
| État | Le choix du personnage et/ou ce qu'il s'est passé pendant l'aventure impactent l'écran de fin. **Indiquez ici comment succintement.** image de fin par personnage. | Non |
